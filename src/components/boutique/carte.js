...
const Carte = () => (
  <StaticQuery
    query={graphql`
      {
        allDatoCmsBoutique(
          filter: {typeDeProduit: {eq: "Carte cadeaux"}}
        ) {
          totalCount
          edges {
            node {
    ...
    `}
    render={data => <section id="carte" className="w-10/12 m-auto flex flex-col justify-center ">
      <h1 className=" titre text-4xl mb-10"> Les cartes cadeaux</h1>
